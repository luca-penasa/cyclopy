...
class KernelSmoother:
	...
	by Springer editions. KdTree can be used for huge datasets. This option is enabled by default. 
	"""
	...
	def __call__(self, x, h = 1, method = 'epa', disable_kdtree = False, just_n_count=False, just_variance = False):
		...
		if (disable_kdtree == True) & (self.use_kdtree == False):
			...
			print('Kdtree searching disabled for this evaluation! By default it would be used. Next run will use it if you dont specifically disable it.')
